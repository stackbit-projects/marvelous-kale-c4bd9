...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fec4bd9934bf90015be4eb9
...
To start editing your site, you can use the Sanity interface at https://marvelous-kale-c4bd9.sanity.studio/.
...
Generated at `2020-12-30T09:44:11.449Z` by Stackbit version `0.3.42`.